...
export default function Kriling() {
  ...
  const [tanggalKriling, setTanggalKriling] = useState(
  ...
  const sendTransaction = (e) => {
    ...
    const bodyReq = {
      ...
      transactionDate: tanggalKriling,
  ...
  return (
    <Container className="bodyHome" style={{ marginLeft: "4%", width: "60%" }}>
      <ModalComponent
